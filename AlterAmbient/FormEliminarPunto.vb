Public Class FormEliminarPunto
    ...
    Public Sub New(ByVal MDB As BBDD.OleDbDataBase, ByVal tipo As String, ByVal proyecto As Integer)
    ...
    Private Sub FormEliminarAlteracion_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Me._Rellenar.RellenarPuntos(Me.lstboxPuntos, Me._idproy)
    End Sub
